...
public class ActivityServiceV1Alpha3IT extends AbstractClientTestV1Alpha3 {
  ...
  public void shouldCreate() throws SocialClientLibException {
    ...
    RestActivity activity = new RestActivity();
    activity.setTitle("Hello World. create a activity");
  ...
  /*
   * @Test public void testCreateGetDeleteActivity() { startSessionAs("demo",
   * "gtn"); String demoIdentityId =
   * identityService.getIdentityId("organization", "demo"); RestActivity
  ...
  /*
   * @Test public void testGetActivitySteam() { startSessionAs("demo", "gtn");
   * String demoIdentityId = identityService.getIdentityId("organization",
   * "demo"); RestIdentity demoIdentity = identityService.get(demoIdentityId);

...
public class ExoConstants {
  ...
  public static final String BRAZIL_LOCALIZATION                   = "pt_BR";

  public static final String GREEK_LOCALIZATION                    = "el";
  ...
  /**
   * Allowed in account username : alphanumeric chars, underscore (_), hyphen
   * (-), dot (.) and plus (+)
   */

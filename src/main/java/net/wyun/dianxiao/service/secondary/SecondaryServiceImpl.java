...
import static net.wyun.dianxiao.config.SecondaryDataSourceConfig.SECONDARY_PERSISTENCE_UNIT;
import static net.wyun.dianxiao.config.SecondaryDataSourceConfig.SECONDARY_PLATFORM_TX_MANAGER;

...
import static net.wyun.dianxiao.config.PrimaryDataSourceConfig.PRIMARY_PERSISTENCE_UNIT;
import static net.wyun.dianxiao.config.PrimaryDataSourceConfig.PRIMARY_PLATFORM_TX_MANAGER;

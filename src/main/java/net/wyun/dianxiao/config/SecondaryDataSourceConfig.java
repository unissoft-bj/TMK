...
@EnableJpaRepositories(entityManagerFactoryRef = "SECONDARY_ENTITY_MANAGER_FACTORY", 
		transactionManagerRef = "SECONDARY_PLATFORM_TX_MANAGER", basePackages = { "net.wyun.dianxiao.repository.secondary" })
public class SecondaryDataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean secondaryEntityManagerFactory(EntityManagerFactoryBuilder builder) {
		return builder.dataSource(secondaryDataSource()).packages("net.wyun.dianxiao.model.secondary")
